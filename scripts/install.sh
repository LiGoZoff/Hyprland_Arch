...
while true; do
    ...
    if [[ $install = lie ]]; then
        ...
        $helper_name -S hyprpicker swww-git clipse hyprshot walcord v2rayn cava vesktop-bin bluetuith-bin onlyoffice-bin ttf-font-icons vkbasalt lib32-vkbasalt proton-ge-custom-bin xone-dkms-git dxvk-bin vkd3d-proton-bin ttf-ionicons protontricks bluez blobdrop-git bluez-utils bluez-deprecated-tools cliphist python-pywalfox visual-studio-code-bin spotify portproton waybar-updates --noconfirm
